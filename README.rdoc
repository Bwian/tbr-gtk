...
==== Windows Executable
This <em>ocra</em> gem creates a bundled Windows executable which contains the ruby interpreter, the TBR application and dependent gems.  The windows platform must include a version of ruby compatible with <em>ocra</em>, the <em>rubygems</em> package manager and preferably the <em>bundle</em> gem.

==== Windows Installer
Inno Setup (http://www.jrsoftware.org/isinfo.php) is used to build a Windows installer.  The TBR release includes a configuration file for Inno Setup.
