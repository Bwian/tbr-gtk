...
Note that this project is no longer maintained following porting and dependency problems with Windows 7/8.  Originally named TBR, this name is now used for the gem which encapsulates the business logic.  Should the project be reactivated, it should be modified to use the tbr gem.
